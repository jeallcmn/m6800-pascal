 ...
 *
 * Disassembly of dsdt.dat, Wed Mar 20 10:46:31 2019
 *
...
DefinitionBlock ("", "DSDT", 2, "DELL  ", "CBX3   ", 0x00000014)
{
    ...
    OperationRegion (GNVS, SystemMemory, 0xcd6d4000, 0x02B4)
    ...
    OperationRegion (SANV, SystemMemory, 0xcd6d5000, 0x016D)
    ...
    OperationRegion (EXBU, SystemMemory, 0xcd6d6000, 0x000E)
    ...
    Scope (_SB.PCI0)
    {
        ...
        Device (B0D3)
        {
            ...
            OperationRegion (RPCS, SystemMemory, XBAS, 0x41)
            Field (RPCS, AnyAcc, Lock, Preserve)
            {
//                Offset (0x18004), 
                ACMD,   8, 
  //              Offset (0x18010), 
